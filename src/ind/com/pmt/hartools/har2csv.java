package ind.com.oracle.hartools;

import java.io.IOException;
import java.io.FileNotFoundException;
import org.apache.wink.json4j.JSONException;

import ind.com.oracle.cliutils.CliArgs;
...
public class har2csv {
	...
	public void gethar2csv(String[] args) {
		...
		if(cliArgs.hasArg("help")) {
			...
			try {				
				cliArgs = new CliArgs(args, argsTrans);
				...
				System.out.println("[ERROR] Malformed HAR file - "+ cliArgs.getValue("in").toString()  +"\n");
			} catch(Exception Ex) {
				Ex.printStackTrace();
			}
		} else {
